...
async function setupRemix(platform) {
  ...
  await Promise.all([fse__namespace.copy(platformExportsDir, remixPkgDir), fse__namespace.copy(serverExportsDir, remixPkgDir), fse__namespace.copy(clientExportsDir, remixPkgDir)]);
}
